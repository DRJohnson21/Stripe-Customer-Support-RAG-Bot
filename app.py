...
if not endpoint or not api_key or not deployment or not vector_store_id:
    st.error(
        "Missing Azure OpenAI settings. Check your .env file. "
        "Required values: AZURE_OPENAI_ENDPOINT, AZURE_OPENAI_API_KEY, "
